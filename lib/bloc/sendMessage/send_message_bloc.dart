...
class SendMessageBloc extends Bloc<SendMessageEvent, SendMessageState> {
  ...
  FutureOr<void> _sendMessage(
    ...
    var sendMessageModel =
        await _messageRepositories.sendMessage(event.receiverId, event.message);
    if (sendMessageModel != null) {
      SendMessageModel sendMessageModelNew = sendMessageModel;
      MessageModel messageModel = MessageModel.fromJson(sendMessageModelNew.message!.toJson());
