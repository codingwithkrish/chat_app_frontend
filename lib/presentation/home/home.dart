                                                        ...
                                                        Container(
                                                          ...
                                                          child: ClipRRect(
                                                            ...
                                                            child: CachedNetworkImage(
                                                              ...
                                                              height: 75,
                                                              width: 75,
                                                              imageUrl: state.usersModel.users![i].profileImageUrl!,
                                                      ...
                                                      child: Column(
                                                        ...
                                                        children: [
                                                          Text(state.usersModel
                                                              .users![i].name!,style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold)),
                                                          Text(state.usersModel
                                                              .users![i].phone!,style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold))
                                                        ],
                                                      ))
                                                ],
                                              ).paddingSymmetric(
